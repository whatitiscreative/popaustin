		...
		<table class="widefat" cellspacing="0">
			...
			<tbody>
				...
				<?php if ( $show_400_migration && false === $force_hide_400_migration ) : ?>
					...
					<tr>
						<td><?php _e( 'Avada 4.0 Conversion:', 'Avada' ); ?></td>
						<td class="help">&nbsp;</td>
						<td>
							<table class="widefat">
								<tr>
									<td style="width:auto;"><?php printf( esc_attr__( 'Rerun Theme Options Conversion from version %s to version 4.0 manually.', 'Avada' ), $last_pre_4_version ); ?></td>
							...
							<script type="text/javascript">
								jQuery( '#avada-manual-400-migration-trigger' ).on( 'click', function( e ) {
									e.preventDefault();
									var migration_response = confirm( "<?php printf( esc_attr__( 'Warning: By clicking OK, all changes made to your theme options after installing Avada 4.0 will be lost. Your Theme Options will be reset to the values from %s and then converted again to 4.0.', 'Avada' ), $latest_version ); ?>" );
				...
				<?php if ( $show_500_migration ) : ?>
					...
					<tr>
						<td><?php _e( 'Avada 5.0 Conversion:', 'Avada' ); ?></td>
						<td class="help">&nbsp;</td>
						<td>
							<table class="widefat">
								<tr>
									<td style="width:auto;"><?php printf( esc_attr__( 'Rerun Shortcode Conversion from version %s to version 5.0 manually.', 'Avada' ), $last_pre_5_version ); ?></td>
							...
							<script type="text/javascript">
								...
								if ( document.getElementById( 'avada-manual-500-migration-revert-trigger' ) ) {
									jQuery( '#avada-manual-500-migration-revert-trigger' ).on( 'click', function( e ) {
										e.preventDefault();
										var migration_response = confirm( "<?php _e( 'Warning: By clicking OK, you will be redirected to the conversion splash screen, where you can start the conversion reversion of your page contents to the old Fusion Builder format.', 'Avada' ); ?>" );
										if ( migration_response == true ) {
											window.location= "<?php echo admin_url( 'index.php?fusion_builder_migrate=1&ver=500&revert=1' ); ?>";
										}
									});
								}
								if ( document.getElementById( 'avada-remove-500-migration-backups' ) ) {
									jQuery( '#avada-remove-500-migration-backups' ).on( 'click', function( e ) {
										e.preventDefault();
										var migration_response = confirm( "<?php _e( 'Warning: This is a non-reversable process. By clicking OK, all backups created during the 5.0 shortcode-conversion process will be removed from your database.', 'Avada' ); ?>" );
										if ( migration_response == true ) {
